...
<div id="content">              
<form action="SUP_Pat.jsp" method="get">
<h2 align="left" style="margin-left:-20px">Cherchez Un Patient</h2>
<ul>
	<li><label for="nom">NSS : </label>
...
<table width="1350" border="1" cellspacing="0.1">
  <tr>
    <th bgcolor="#95D5FF" scope="col">&nbsp;NSS_PAT</th>
...
<%
	...
	ArrayList patients = DBManager.getPats(mat_pat, nom_pat, prn_pat);
